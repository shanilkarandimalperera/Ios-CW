...
class ExcrisenormalfiveController: UIViewController {
    ...
    let image: UIImageView = {
        let image = UIImageView()
        image.image = UIImage(named: "Squats")
    ...
    func playVideo() {
        guard let videoURLString = urllabel.text, let videoURL = URL(string: "https://youtu.be/rMvwVtlqjTE") else {
